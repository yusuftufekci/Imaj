...
{
    public class BasePropQryConfiguration : IEntityTypeConfiguration<BasePropQry>
    {
        public void Configure(EntityTypeBuilder<BasePropQry> builder)
        {
            builder.ToTable("BasePropQry");
