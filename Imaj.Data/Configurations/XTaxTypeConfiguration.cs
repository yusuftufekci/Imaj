...
{
    public class XTaxTypeConfiguration : IEntityTypeConfiguration<XTaxType>
    {
        public void Configure(EntityTypeBuilder<XTaxType> builder)
        {
            builder.ToTable("XTaxType");
            ...
            builder.Property(e => e.InvoLinePostfix).HasMaxLength(32).IsRequired();
