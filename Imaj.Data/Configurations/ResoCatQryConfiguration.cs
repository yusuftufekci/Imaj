...
{
    public class ResoCatQryConfiguration : IEntityTypeConfiguration<ResoCatQry>
    {
        public void Configure(EntityTypeBuilder<ResoCatQry> builder)
        {
            builder.ToTable("ResoCatQry");
