...
{
    public class WorkTypeQryConfiguration : IEntityTypeConfiguration<WorkTypeQry>
    {
        public void Configure(EntityTypeBuilder<WorkTypeQry> builder)
        {
            builder.ToTable("WorkTypeQry");
