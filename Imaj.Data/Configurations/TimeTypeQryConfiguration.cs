...
{
    public class TimeTypeQryConfiguration : IEntityTypeConfiguration<TimeTypeQry>
    {
        public void Configure(EntityTypeBuilder<TimeTypeQry> builder)
        {
            builder.ToTable("TimeTypeQry");
