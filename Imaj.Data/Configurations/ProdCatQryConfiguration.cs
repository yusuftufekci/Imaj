...
{
    public class ProdCatQryConfiguration : IEntityTypeConfiguration<ProdCatQry>
    {
        public void Configure(EntityTypeBuilder<ProdCatQry> builder)
        {
            builder.ToTable("ProdCatQry");
