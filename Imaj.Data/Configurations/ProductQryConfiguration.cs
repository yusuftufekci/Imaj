...
{
    public class ProductQryConfiguration : IEntityTypeConfiguration<ProductQry>
    {
        public void Configure(EntityTypeBuilder<ProductQry> builder)
        {
            builder.ToTable("ProductQry");
            ...
            builder.Property(e => e.FixedFunction).HasColumnType("bit").IsRequired();
            ...
            builder.Property(e => e.ProdCatID).HasColumnType("decimal(6, 0)");
        }
    }
}
